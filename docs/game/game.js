...
import { GameState, GameStateDef, registerGameStateSystems, } from "./gamestate.js";
...
function registerRenderViewController(em) {
    em.registerSystem([], [InputsDef, RendererDef, CameraDef, LocalPlayerDef], (_, { inputs, renderer, camera, localPlayer }) => {
        // check render mode
