...
export function registerPlayerSystems(em) {
        ...
        for (let i = 0; i < res.physicsTimer.steps; i++) {
            ...
            for (let p of players) {
                ...
                if (CHEAT && inputs.keyClicks["t"]) {
                    const targetId = (_b = (_a = em.getResource(GlobalCursor3dDef)) === null || _a === void 0 ? void 0 : _a.cursor()) === null || _b === void 0 ? void 0 : _b.cursor3d.hitId;
                    if (targetId) {
                ...
                if (CHEAT && res.inputs.keyClicks["backspace"]) {
                    const targetId = (_d = (_c = em.getResource(GlobalCursor3dDef)) === null || _c === void 0 ? void 0 : _c.cursor()) === null || _d === void 0 ? void 0 : _d.cursor3d.hitId;
                    if (targetId)
    ...
    em.registerSystem([PlayerDef, AuthorityDef, PositionDef, LinearVelocityDef], [PhysicsResultsDef, MeDef], (players, res) => {
        var _a;
        for (let p of players) {
            if (p.authority.pid !== res.me.pid)
                continue;
            ...
            const shipHits = (_a = res.physicsResults.collidesWith
                .get(p.id)) === null || _a === void 0 ? void 0 : _a.map((h) => em.findEntity(h, [ShipLocalDef, ColliderDef]));
